...
import pageObjects.ManageShipmentsPage;
import pageObjects.SupplyChainExecutionPage;
import testBase.BaseClass;

public class TC_07_ManageShipmentsTest extends BaseClass {
	...
	ManageShipmentsPage msp = new ManageShipmentsPage(driver);
	
	msp.tasksLogo();
	msp.manageShipping();
	msp.shippmentField(null);
	msp.searchButton();
	msp.shippingMethodDropdown();
	msp.byAirOption();
	msp.shipConfirmButton();
	msp.yesButton();
	msp.saveDropdown();
	msp.saveAndClose();
	msp.f1Logo();
